...
1a. NOTE: this repository contains the configuration files generated with ver. 1-14 of GNU autotools.
If your version differs one needs to run `aclocal` and `automake` first to regenerate the
